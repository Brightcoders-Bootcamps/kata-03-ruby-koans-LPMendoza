...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject execute a block with each item of a array, the first argument is the initial value
    # wich will interact with the first array item, the second argument is the actual array item  
  end
